...
if [ "$(systemd-detect-virt)" == "openvz" ]; then
  ...
  sleep 1
  echo -e "[ ${tyblue}NOTES${NC} ] Auto Script VPS By ZEXX TUNNELING"
  sleep 1
...
echo -e "
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY https://github.com/AriSaputra1205$NC       │
    └───────────────────────────────────────────────┘
          ${RED} SCRIPT AUTO INSTALL ZEXX TUNNELING ${FONT}    
           ${RED} SCRIPT MOD BY ZEXX TUNNELING ${FONT}
...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
    ...
    wget -q https://raw.githubusercontent.com/AriSaputra1205/zexx/main/xray/bbr.sh &&  chmod +x bbr.sh && ./bbr.sh
...
#install cf
wget -q https://raw.githubusercontent.com/AriSaputra1205/zexx/main/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/AriSaputra1205/zexx/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
# install backup
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install backup             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget https://raw.githubusercontent.com/AriSaputra1205/zexx/main/backup/set-br && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://raw.githubusercontent.com/AriSaputra1205/zexx/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install Websocket             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/AriSaputra1205/zexx/main/sshws/dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/AriSaputra1205/zexx/main/sshws/ws-stunnel
...
[Unit]
Description=Websocket Python By ZEXX TUNNELING
